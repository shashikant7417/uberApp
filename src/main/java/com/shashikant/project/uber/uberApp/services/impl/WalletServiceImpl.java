...
import com.shashikant.project.uber.uberApp.repositories.WalletRepository;
...
public class WalletServiceImpl implements WalletService {
    ...
    public Wallet findByUser(User user) {
        return walletRepository.findByUser(user)
                .orElseThrow(()-> new ResourceNotFoundException(" Wallet not found with user with id :"+ user.getId()));
    }
}
